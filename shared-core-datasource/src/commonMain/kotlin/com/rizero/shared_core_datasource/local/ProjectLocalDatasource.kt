...
interface ProjectLocalDatasource {
    ...
    suspend fun createNewProject(projectName : String, userPhone: String)
    suspend fun saveRegisteredProject(projectID : String, projectName: String, membersCount : Int, role: Role, userPhone: String)
